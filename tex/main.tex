...
Dodatkowym problemem podczas treningu modeli jest problem zanikającego gradientu. Równanie \ref*{equ:gradient} przedstawia równania potrzebne w celu policzenia konkretnego stanu ukrytego $H_i$.
...
Do tokenizacji plików MIDI zastosowano algorytm REMI o którym była mowa w rozdziale \ref*{sec:REMI}. Przekształca on dane muzyczne z formatu MIDI w sekwencje tokenów, które mogą być interpretowane przez modele.
