...
Muzyka, lub szerzej zapis dowolnego audio, może być zapisywana na dysku na wiele sposobów. Nie wszystkie jednak mogą być przetwarzane w taki sam sposób przez modele uczenia maszynowego. Poniżej zostały przeanalizowane typowe cyfrowe zapisy dźwięku, które są typowo używane w problemach wymagających sztucznej inteligencji.
...
\begin{figure}[ht!]
    \begin{center}
        \includegraphics*[width=\linewidth]{./img/midi_output_5_sheet.pdf}
    \end{center}
    \caption{Muzyka zapisana z pliku MIDI}\label{fig:jsb_sheet}
\end{figure}

Warto zaobserwować, że
...
\begin{figure}[ht!]
    \begin{minted}{text}
X: 267
T: Nocturne No. 1 Op. 32
C: F. Chopin
L: 1/8
M: C
N: Derived from 032-1-Sm-001.krn
P: Deux Nocturnes
Q: "Andante sostenuto."
%%staves {1 2}
V: 1 clef=treble
...
[V:1] B2-B/d/b/g/f3e |
[V:2] [DB,]FF,F [CA,]FF,F |
[V:1] d(3d/e/f/e>dc2d3/A/ |
[V:2] B,,FF,F [EA,]FF,F |
[V:1] B/c/!mordent!B/^A/ B/d/b/g/f3e |
[V:2] [DB,]FF,F [CA,]FF,F |
[V:1] d2^^c>d^e2{/eg} f3/e/ |
[V:2] B,,F,=A,D ^A,,G,^A,^^C |
[V:1] d2A2c2G3/ !fermata!z/ |
[V:2] D,,F,A,D E,,E,G,C/ !fermata!z/ |
[V:1] z z/ B/ (5:4:5B/c/B/^A/B/ dd2c |
[V:2] .=G,,E,B,E .F,,F,^A,E |
[V:1] x2g2c2d2 & B4A2=A2 |
[V:2] xx2xE2^B,2 & xF,2^F,2F,2x |
[V:1] {/f}e2dcB2c2 & ^A4F2G2 |
    \end{minted}
...
\begin{figure}[ht!]
    \begin{center}
        \includegraphics[width=0.8\linewidth]{img/abc_notation2.pdf}
    \end{center}
    \caption{Reprezentacja melodii z notacji \ref*{abc:polyphony}}
    \label{fig:abc_polyphony}
\end{figure}
