...
\begin{table}[ht!] % to jest do poprawy
    \centering
    \begin{tabular}{|l|l|l|}
        \hline
...
\end{comment}
\begin{itemize}
    \item \texttt{S:} - liczba sekcji w całym utworze; tag jest \textcolor{blue}{łatwy} do policzenia ponieważ początek i koniec taktu jest jawnie oznaczany przy pomocy symboli \texttt{[|}, \texttt{||}, \texttt{|]}, \texttt{|:}, \texttt{::} i \texttt{:|}
